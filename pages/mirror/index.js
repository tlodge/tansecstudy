          ...
          <div className="grid grid-cols-12">
            ...
            <div className="color white w-full pl-6 pr-6">
              ...
              <div className="col-span-10 p-4">
                 <div className="text-white">How easy do you think it would be to remember different objects?</div>
                 <div className="text-white opacity-50 text-xs">i.e. remember different objects for a range of authorised tasks</div>
              </div>
              <div className="color white w-full pl-6 pr-6">
                    <div className="bg-lightgray p-4">
